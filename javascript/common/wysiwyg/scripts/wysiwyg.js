...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = JSRL+"javascript/common/wysiwyg/images/";
		
		// Popups Directory
		this.PopupsDir = JSRL+"javascript/common/wysiwyg/popups/";
		
		// CSS Directory File
		this.CSSFile = JSRL+"javascript/common/wysiwyg/styles/wysiwyg.css";		
